    ...
    public class LibaryDB
    {
        ...
        private LibaryDB()
        {
            ...
            Persons = new List<Person>
            {
                ...
                new Costumer("472789320","Fname3 ","Lname","Rehovot","none"),
                new Costumer("453783474","Fname4 ","Lname","Rehovot","none"),
                new Costumer("999095433","Fname5 ","Lname","Rehovot","none"),
                new Costumer("999326176","Fname6 ","Lname","Rehovot","none"),
                new Costumer("999297849","Fname7 ","Lname","Rehovot","none"),
                new Costumer("000000117","Fname8 ","Lname","Rehovot","none"),
                new Costumer("111111118","Fname9 ","Lname","Rehovot","none"),
                new Costumer("234234235","Fname10 ","Lname","Rehovot","none"),
